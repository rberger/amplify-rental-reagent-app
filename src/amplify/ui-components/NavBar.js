...
export default function NavBar(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
    ...
    direction: "row",
    height: "45px"
  }, getOverrideProps(overrides, "Flex.Flex[0]")), /*#__PURE__*/React.createElement(Icon, _extends({
    ...
    position: "relative",
    height: "18px"
  }, getOverrideProps(overrides, "Flex.Flex[0].Icon[0]"))), /*#__PURE__*/React.createElement(Text, _extends({
    padding: "0px 0px 0px 0px",
    color: "rgba(0,0,0,1)",
    textAlign: "left",
    shrink: "0",
    ...
    direction: "column",
    children: "Applicants"
  }, getOverrideProps(overrides, "Flex.Flex[1].Text[2]"))), /*#__PURE__*/React.createElement(Text, _extends({
    padding: "0px 0px 0px 0px",
    color: "rgba(0,0,0,1)",
    textAlign: "left",
    shrink: "0",
    ...
    direction: "column",
    children: "Company"
  }, getOverrideProps(overrides, "Flex.Flex[1].Text[3]")))), /*#__PURE__*/React.createElement(Flex, _extends({
    padding: "0px 0px 0px 0px",
    grow: "1",
    alignItems: "center",
    gap: "32px",
    ...
    direction: "row",
    height: "45px"
  }, getOverrideProps(overrides, "Flex.Flex[2]")), /*#__PURE__*/React.createElement(SearchField, _extends({
    labelHidden: "true",
    size: "default",
    shrink: "0",
    display: "flex",
    ...
    variation: "default",
    height: "32px"
  }, getOverrideProps(overrides, "Flex.Flex[2].SearchField[0]"))), /*#__PURE__*/React.createElement(IconNotifications, _extends({
    padding: "0px 0px 0px 0px",
    overflow: "hidden",
    ...
    type: "notifications",
    height: "24px"
  }, getOverrideProps(overrides, "Flex.Flex[2].IconNotifications[0]"))), /*#__PURE__*/React.createElement(Image, _extends({
    width: "45px",
    padding: "0px 0px 0px 0px",
    position: "relative",
    borderRadius: "160px",

...
export default function ProfileA(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
    ...
    position: "relative",
    direction: "row"
  }, getOverrideProps(overrides, "Flex.Flex[1]")), /*#__PURE__*/React.createElement(IconGroup, _extends({
    padding: "0px 0px 0px 0px",
    overflow: "hidden",
    color: "rgba(13.000000175088644,26.000000350177288,38.0000015348196,1)",
    shrink: "0",
    ...
    type: "group",
    height: "24px"
  }, getOverrideProps(overrides, "Flex.Flex[1].IconGroup[0]"))), /*#__PURE__*/React.createElement(Text, _extends({
    padding: "0px 0px 0px 0px",
    color: "rgba(48.000000938773155,64.00000378489494,80.00000283122063,1)",
    textAlign: "center",
    shrink: "0",
  ...
  }, getOverrideProps(overrides, "Flex.Flex[1].Text[0]")))), /*#__PURE__*/React.createElement(Button, _extends({
    alignSelf: "stretch",
    size: "large",
    shrink: "0",
    variation: "primary",

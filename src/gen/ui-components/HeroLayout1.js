...
export default function HeroLayout1(props) {
  ...
  const mergeVariantsAndOverrides = (variants, overrides) => {
    ...
    const merged = Object.fromEntries(sharedKeys.map(sharedKey => [sharedKey, { ...variants[sharedKey],
      ...overrides[sharedKey]
    }]));
    return { ...variants,
      ...overrides,
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
    ...
    direction: "column",
    children: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
  }, getOverrideProps(overrides, "Flex.Flex[0].Flex[0].Flex[0].Text[1]")))), /*#__PURE__*/React.createElement(Button, _extends({
    width: "206px",
    size: "large",
    shrink: "0",
    variation: "primary",
    display: "flex",
    children: "Primary Button"
  }, getOverrideProps(overrides, "Flex.Flex[0].Flex[0].Button[0]"))))), /*#__PURE__*/React.createElement(Flex, _extends({
    padding: "0px 0px 0px 0px",
    alignSelf: "stretch",
    grow: "1",
    overflow: "hidden",
